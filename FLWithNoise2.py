...
import glob, random
images = glob.glob("./noisy_data/small_scale/stylegan-oriented/train/00000000/*.jpg")
print(len(images))
...
if __name__ == '__main__':
    ...
    print(plot_str)
    plot_str = f"Supplement: {args.supplement}, Mixup: {args.mixup_prop} (Mixup_k:{args.mix_num}, Laplacian Scale: {args.laplace_scale}), Natural: {args.natural_img_prop}, Real: {args.real_prop}"
    print(plot_str)
